...
inline InfoSetKey make_infoset_key(
    ...
    key.p0_committed_this_round = public_state.betting.p0_committed_this_round;

    key.p1_committed_this_round = public_state.betting.p1_committed_this_round;

    key.current_bet_to_call = public_state.betting.current_bet_to_call;

    key.num_raises_this_street = public_state.betting.num_raises_this_street;
